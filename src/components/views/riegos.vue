...
let validaciones = () => {
  ...
  if(diasTransplante.value === "" || String(diasTransplante.value).trim() === ""){
    alert("Los días transplante son obligatorios");
    return false;
  }
  if(estadoFenologico.value === "" || estadoFenologico.value.trim() === ""){
    alert("El estado fenológico es obligatorio");
    return false;
  }
  if(horaInicio.value === ""){
    alert("La hora inicio es obligatoria");
    return false;
  }
  if(horaFin.value === ""){
    alert("La hora fin es obligatoria");
    return false;
  }
  ...
  if(cantidadAgua.value === "" || String(cantidadAgua.value).trim() === ""){
    alert("La cantidad de agua es obligatoria");
    return false;
  }
}
