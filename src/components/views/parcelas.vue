    ...
    <div class="cont_form" v-if="formulario">
      <div class="form">
        ...
        <div class="titulo_form">
          <p v-if="variable === 0" class="text_titulo_form">crear parcela</p>
          <p v-else class="text_titulo_form">editar parcela</p>
        </div>
        <div class="cont_inputs">
          <p class="text_inputs">numero</p>
          <input type="Number" class="inputs" v-model="numero">
        </div>
        <div class="cont_inputs">
          <p class="text_inputs">ubicación geográfica</p>
        ...
        <div class="cont_inputs">
          <p class="text_inputs">cultivo actual</p>
          <input type="text" class="inputs" v-model="cultivoActual">
        </div>
        <div class="cont_inputs">
          <p class="text_inputs">detalles</p>
          <input type="text" class="inputs" v-model="detalles">
        </div>
        <div class="cont_inputs">
          <p class="text_inputs">área</p>
          <input type="text" class="inputs" v-model="area">
        </div>
        <div class="cont_inputs">
          <p class="text_inputs">asistente técnico</p>
          <input type="text" class="inputs" v-model="asistenteTecnico">
        </div>
        <div class="cont_inputs">
        ...
        <div class="cont_inputs">
          <p class="text_inputs">fecha de creacion</p>
          <input type="date" class="inputs" v-model="fechaCreacion">
        </div>
...
let listarTodos = async () => {
  spinner.value = true;
  r = await useParcelas.getParcelas();
...
let listarActivos = async () => {
  spinner.value = true;
  r = await useParcelas.getActivos();
  rows.value = r.parcelas;
  spinner.value = false;
};

let listarInactivos = async () => {
  spinner.value = true;
  r = await useParcelas.getInactivos();
  rows.value = r.parcelas;
  spinner.value = false;
};
...
let activar = async (row) => {
  spinner.value = true;
  r = await useParcelas.putActivar(row._id);
  listarTodos();
  spinner.value = false;
};
...
let desactivar = async (row) => {
  spinner.value = true;
  r = await useParcelas.putDesactivar(row._id);
  listarTodos();
  spinner.value = false;
};
...
let validaciones = () => {
  if(numero.value === "" || String(numero.value).trim() === ""){
    text.value = "El número es obligatorio";
  ...
  if(cultivoAnterior.value === "" || cultivoAnterior.value.trim() === ""){
    text.value = "El cultivo anterior es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if(cultivoActual.value === "" || cultivoActual.value.trim() === ""){
    text.value = "El cultivo actual es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if(detalles.value === "" || detalles.value.trim() === ""){
    text.value = "Los detalles son obligatorios";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if(asistenteTecnico.value === "" || asistenteTecnico.value.trim() === ""){
    text.value = "El asistente técnico es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if(fechaCreacion.value === "" || fechaCreacion.value.trim() === ""){
    text.value = "La fecha de creación es obligatoria";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
let editar = async (data) => {
  ...
  cultivoActual.value = data.cultivoActual;
  detalles.value = data.detalles;
  area.value = data.area;
  asistenteTecnico.value = data.asistenteTecnico;
  fincaOption.value = fincas.value.findIndex((f) => f._id == data.id_finca) + 1;
  fechaCreacion.value = data.fecha_Creacion.split("T")[0];
  formulario.value = true;
  spinner.value = false;
}
...
let enviarCrear = async () => {
  ...
  spinner.value = true;
  await useParcelas.postParcelas(data);
  cerrarForm();
  spinner.value = false;
...
let enviarEditar = async () => {
  ...
  spinner.value = true;
  await useParcelas.putParcelas(id.value, data);
  cerrarForm();
  spinner.value = false;
