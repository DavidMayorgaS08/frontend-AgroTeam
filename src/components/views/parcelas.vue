...
let validaciones = () => {
  ...
  if(ubicacionGeografica.value === "" || ubicacionGeografica.value.trim() === ""){
    alert("El campo ubicación geográfica es obligatorio");
    return false;
  }
  if(cultivoAnterior.value === "" || cultivoAnterior.value.trim() === ""){
    alert("El campo cultivo anterior es obligatorio");
    return false;
  }
  if(cultivoActual.value === "" || cultivoActual.value.trim() === ""){
    alert("El campo cultivo actual es obligatorio");
    return false;
  }
  ...
  if(asistenteTecnico.value === "" || asistenteTecnico.value.trim() === ""){
    alert("El campo asistente técnico es obligatorio");
    return false;
  }
  if(fincaOption.value === ""){
    alert("El campo finca es obligatorio");
    return false;
  }
  if(fechaCreacion.value === "" || fechaCreacion.value.trim() === ""){
    alert("El campo fecha de creación es obligatorio");
    return false;
  }
}
