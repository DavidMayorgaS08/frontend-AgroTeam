    ...
    <div class="cont_form" v-if="formulario">
      <div class="form">
        ...
        <div class="titulo_form">
          <p v-if="variable === 0" class="text_titulo_form">crear factura</p>
          <p v-else class="text_titulo_form">editar factura</p>
        </div>
...
let validaciones = () => {
  ...
  if(nombreProducto.value === "" || nombreProducto.value.trim() === "") {
    text.value = "El nombre del producto es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if(subTotal.value === "" || String(subTotal.value).trim() === "") {
    text.value = "El subtotal es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if(iva.value === "" || String(iva.value).trim() === "") {
    text.value = "El iva es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if(compradorOption.value === "") {
    text.value = "El comprador es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
