  ...
  <div class="app">
    ...
    <div class="cont_form" v-if="formulario">
      <div class="form">
        ...
        <div class="cont_inputs">
          <p class="text_inputs">limites predios</p>
          <input type="text" class="inputs" v-model="limitesPredios">
        </div>
        <div class="cont_inputs">
...
let columns = ref([
  ...
  {
    name: "limitesPredios",
    label: "Limites Predios",
    align: "center",
    field: "limitesPredios",
  },
  {
    name: "area",
    label: "Area",
...
let validaciones = () => {
  if(adminOption.value === ""){
    alert("El campo administrador es obligatorio");
    return false;
  }
  ...
  if(ubicacionGeografica.value === "" || ubicacionGeografica.value.trim() === ""){
    alert("El campo ubicacion geografica es obligatorio");
    return false;
  }
  if(limitesPredios.value === "" || limitesPredios.value.trim() === ""){
    alert("El campo limites predios es obligatorio");
    return false;
  }
...
let editar = async (data) => {
  ...
  limitesPredios.value = data.limitesPredios;
...
let enviarCrear = async () => {
  ...
  let data = {
    ...
    limitesPredios: limitesPredios.value,
    area: area.value,
    ciudad: ciudad.value,
