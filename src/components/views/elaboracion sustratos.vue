...
let validaciones = () => {
  ...
  if(productoComercial.value === "" || productoComercial.value.trim() === "") {
    alert("El producto comercial es obligatorio");
    return false;
  }
  ...
  if(dosisUtilizada.value === "" || String(dosisUtilizada.value).trim() === "") {
    alert("La dosis utilizada es obligatoria");
    return false;
  }
  if(metodoAplicacion.value === "" || metodoAplicacion.value.trim() === "") {
    alert("El metodo de aplicacion es obligatorio");
    return false;
  }
  ...
  if(empleadoResponsableOption.value === "") {
    alert("El empleado responsable es obligatorio");
    return false;
  }
