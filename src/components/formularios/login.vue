<template>
  <div class="app">
    <div class="login-box" v-if="!showRecoverPassword">
      ...
      <p class="forgot-password">
        <router-link to="/RecuperarContrasena">
          <a href="#" class="a2" @click="toggleRecoverPassword">¿Olvidaste la Contraseña?</a>
        </router-link>
      </p>
    </div>
